...
export default function FamilyDocumentsPage() {
    ...
    if (loading) return <DashboardLayout userRole="FAMILY" userName="Family" userEmail="family@airbase.mil"><div className="flex items-center justify-center h-64"><div className="text-slate-400 font-mono">Loading...</div></div></DashboardLayout>;

    return (
        <DashboardLayout userRole="FAMILY" userName="Family" userEmail="family@airbase.mil">
            <div className="space-y-6">
                <div><h1 className="text-2xl font-chivo font-bold uppercase tracking-wider text-slate-100">Family Resources</h1><p className="text-slate-400 mt-1 text-sm font-mono">Welfare information, guides, and resources</p></div>
