...
export default function OpsAircraftPage() {
                        ...
                        <table className="w-full">
                            <thead className="bg-slate-900/50">
                                <tr>
                                    ...
                                    <th className="px-6 py-3 text-left text-xs font-mono text-slate-500 uppercase tracking-wider">Fuel</th>
                                ...
                                {filteredAircraft.map((ac) => (
                                    <tr key={ac.id} className="hover:bg-slate-800/50 transition-colors">
                                        ...
                                        <td className="px-6 py-4 font-mono text-sm">
                                            <span className={ac.fuelLevel && ac.fuelLevel > 80 ? 'text-green-400' : 'text-yellow-400'}>
                                                {ac.fuelLevel?.toFixed(1)}%
                                            </span>
                                        </td>
