...
export default function OpsDocumentsPage() {
    ...
    if (loading) return <DashboardLayout userRole="OPS_OFFICER" userName="Ops Officer" userEmail="ops@airbase.mil"><div className="flex items-center justify-center h-64"><div className="text-slate-400 font-mono">Loading...</div></div></DashboardLayout>;

    return (
        <DashboardLayout userRole="OPS_OFFICER" userName="Ops Officer" userEmail="ops@airbase.mil">
            <div className="space-y-6">
                <div><h1 className="text-2xl font-chivo font-bold uppercase tracking-wider text-slate-100">Operations Documents</h1><p className="text-slate-400 mt-1 text-sm font-mono">Operations manuals, schedules, and reference materials</p></div>
