...
export default function CommanderMaintenancePage() {
    ...
    return (
        <DashboardLayout userRole="COMMANDER" userName="Commander" userEmail="commander@airbase.mil">
            <div className="space-y-6">
                <h3 className="text-2xl font-chivo font-bold uppercase tracking-wider">Maintenance Overview</h3>
                        ...
                        <table className="w-full">
                            <thead className="bg-slate-900/50">
                                <tr>
                                    ...
                                    <th className="px-6 py-3 text-left text-xs font-mono text-slate-500 uppercase tracking-wider">Due Date</th>
                                </tr>
                            </thead>
