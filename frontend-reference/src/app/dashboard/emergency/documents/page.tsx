...
export default function EmergencyDocumentsPage() {
    ...
    if (loading) return <DashboardLayout userRole="EMERGENCY" userName="Emergency" userEmail="ert@airbase.mil"><div className="flex items-center justify-center h-64"><div className="text-slate-400 font-mono">Loading...</div></div></DashboardLayout>;

    return (
        <DashboardLayout userRole="EMERGENCY" userName="Emergency" userEmail="ert@airbase.mil">
            <div className="space-y-6">
                <div><h1 className="text-2xl font-chivo font-bold uppercase tracking-wider text-slate-100">Emergency Documents</h1><p className="text-slate-400 mt-1 text-sm font-mono">Emergency SOPs, protocols, and quick reference guides</p></div>
