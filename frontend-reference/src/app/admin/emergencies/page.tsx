...
import { Siren, Plus, MagnifyingGlass } from '@phosphor-icons/react';
        ...
        <DashboardLayout userRole="ADMIN" userName="Admin" userEmail="admin@airbase.mil">
            <div className="space-y-6">
                <div className="flex items-center justify-between">
                    ...
                    <button className="flex items-center gap-2 bg-red-600 hover:bg-red-500 text-white rounded-sm font-medium tracking-wide uppercase text-sm px-4 py-2.5 shadow-[0_0_10px_rgba(239,68,68,0.5)] transition-all duration-150">
